...
public class XoxManagerImpl implements XoxManager {
    ...
    @Override
    @GetMapping(value = "/xox", produces = "application/json; charset=utf-8")
     ...
     */
    @Override
    @DeleteMapping("/xox/{gameid}")
    public void removeGame(@PathVariable("gameid") long gameId) {
     ...
     */
    @Override
    @PostMapping(value = "/xox", consumes = "application/json; charset=utf-8")
    public long addGame(@RequestBody XoxInitSettings initSettings) {
     ...
     */
    @Override
    @GetMapping(value = "/xox/{gameid}/board", produces = "application/json; charset=utf-8")
    public BoardReadOnly getBoard(@PathVariable("gameid") long gameId) {
     ...
     */
    @Override
    @GetMapping(value = "/xox/{gameid}/players", produces = "application/json; charset=utf-8")
    public Player[] getPlayers(@PathVariable("gameid") long gameId) {
     ...
     */
    @Override
    @GetMapping(value = "/xox/{gameid}/players/{playername}/actions", produces = "application/json; charset=utf-8")
    public XoxClaimFieldAction[] getActions(@PathVariable("gameid") long gameId, @PathVariable("playername") String player) {
     ...
     */
    @Override
    @PostMapping("/xox/{gameid}/players/{playername}/actions/{action}")
    public void performAction(@PathVariable("gameid") long gameId, @PathVariable("playername") String player, @PathVariable("action") int actionIndex) {
     ...
     */
    @Override
    @GetMapping(value = "/xox/{gameid}", produces = "application/json; charset=utf-8")
    public Ranking getRanking(@PathVariable("gameid") long gameId) {
