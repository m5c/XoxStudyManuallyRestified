...
public class XoxController {
    ...
    /**
     * Private default constructor. Initializes all required util classes and start a new game
     * with players "X" and "O".
     */
    public XoxController() {
     ...
     */
    @PutMapping(value = "/xox", consumes = "application/json; charset=utf-8")
    public void initGame(@RequestBody XoxInitSettings initSettings) {
     ...
     */
    @GetMapping(value = "/xox/board", produces = "application/json; charset=utf-8")
     ...
     */
    @GetMapping(value = "/xox/players", produces = "application/json; charset=utf-8")
     ...
     */
    @GetMapping(value = "/xox/players/{playername}/actions", produces = "application/json; charset=utf-8")
    public Map<String, Action> getActions(@PathVariable("playername") String player) {
     ...
     */
    @PostMapping("/xox/players/{playername}/actions/{action}")
    public void selectAction(@PathVariable("playername") String player, @PathVariable("action") String actionMD5) {
